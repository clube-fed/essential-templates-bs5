...
Append in `</head>` above scripts:
```
<script src="https://static.clubessential.com/libs/bs5/js/bootstrap.min.js"></script>
```
...
### Other tab
*** **Leave 'Enable Bootstrap' disabled.** *** (If down the road we're able to get Dev to point this checkbox to our bootstrap 5.3 version, then this can be removed. Until then, it's better to leave it unchecked.)
