        ...
        concat: {
            dist: {
                src: [
                    ...
                    // './js/components/calOpt1-prem.js',
                    './js/components/calOpt2.js',
                    // './js/components/calOpt2-prem.js',
                    './js/components/calOpt3.js',
                    // './js/components/calOpt3-prem.js',
                    //'./js/components/calOpt4.js',
                    // './js/components/calOpt4-prem.js',
                    // './js/components/calOpt5-prem.js',
                    './js/components/articleOpt3.js',
                    // './js/components/articleOpt3-prem.js',
                    // './js/components/articleOpt5-prem.js',
                    // './js/components/articleOpt6-prem.js',
                    ...
                    // './js/components/cardOpt1-prem.js',
                    './js/components/cardOpt2.js',
                    // './js/components/cardOpt2-prem.js',
                    './js/components/cardOpt3.js',
                    // './js/components/cardOpt3-prem.js',
                    // './js/components/cardOpt4-prem.js',
                    // './js/components/cardOpt5-prem.js',
                    // './js/components/cardOpt6-prem.js',
                    // './js/components/crossmarketing-prem.js',
                    // './js/components/meetTheTeam-prem.js',
                    './js/components/forms.js',
                    './js/components/lightbox.js',
                    './js/components/last.js'
                ],
